...
const CARD_CLASS =
  "z-50 w-72 rounded-xl border border-border bg-[var(--glass-bg)] p-3 text-foreground outline-none backdrop-blur-xl backdrop-saturate-[1.8] backdrop-brightness-105 shadow-[0_18px_40px_rgba(74,51,40,0.16),inset_0_1px_0_var(--glass-highlight),inset_0_0_0_1px_var(--glass-edge)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95";
